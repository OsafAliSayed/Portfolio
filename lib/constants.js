export const reviews = [
  ...
  },
  {
    id: 4,
    name: "Majid Ali",
    company: "Full Stack AI Developer - Upwork",
    rating: 5,
    review: `Outstanding experience. Osaf quickly understood our existing Django and Next.js application 
    and resolved several backend, frontend, and AI-related issues with precision. Their debugging approach was 
    structured and efficient, and communication was excellent throughout the project. Everything was delivered on time 
    with clean and maintainable code. I would absolutely work with them again and highly recommend them for complex 
    full-stack and AI-related projects.`,
    date: "August 2025",
  },
  {
    id: 5,
    name: "Carl Johan Larrson",
    company: "Mock Service - Upwork",
    rating: 5,
    date: "September 2025",
  }
];
...
export const projects = [
  {
    title: "Noah - AI",
    desc: "An AI-powered personal assistant that helps client interview me for different roles and skills removing interview hassle.",
    tags: ['NextJs', 'Vercel', 'OpenAI', 'React' ],
    link: "https://noah.osafalisayed.com",
    logo: "/images/projects/noah-ai-logo.webp",
    images: [
      // Add showcase images here
  ...
  },
  {
    ...
    tags: ['Django', 'Python', 'NextJs', 'React'],
    link: "https://www.github.com/osafalisayed/aikaatib",
    logo: "/images/projects/ai-kaatib-logo.webp",
    images: [
      // Add showcase images here
      "/images/placeholder1.webp",
    ]
  },
  {
    ...
    tags: ['NextJs', 'TypeScript', 'ChartJS', 'React', ],
    link: "https://www.github.com/osafalisayed/crypto-dashboard",
    logo: "/images/projects/cryptodash-logo.webp",
    images: [
      // Add showcase images here
      "/images/placeholder1.webp",
    ]
...
export const contributions = [
  {
    ...
    company: "Frappe",
    logo: "/images/opensource/frappe.webp",
  ...
  },
  {
    ...
    company: "Wagtail",
    logo: "/images/opensource/wagtail.webp",
...
export const experiences = [
  {
    ...
    location: "Remote",
    logo: "/images/experience/ecomlytix_logo.webp",
    description: [
      {
    ...
    technologies: ["GitHubActions", "NextJs", "NestJs", "TailwindCSS", "PostgreSQL", "NodeJs"]
  },
  {
    id: 2,
    company: "Zenduty",
    ...
    location: "Remote",
    logo: "/images/experience/zenduty_logo.webp",
    description: [
      {
    ...
    technologies: ["Python", "Django", "Docker", "React", "PostgreSQL", "AWS"],
  },
  {
    id: 3,
    ...
    location: "Remote",
    logo: "/images/experience/algofinancials_logo.webp",
    description: [
      {
    ...
    technologies: ["TypeScript", "MaterialUI", "ChartJS", "React"],
  }
];


export const contactInfo = {
  email: 'hi@osafalisayed.com',
...
export const snippets = [
  {
    title: "Script: A simple script to find relevant youtube channels for your topic",
    desc: "This script is for marketing purposes to find possible leads you can reach out to",
    link: "https://www.github.com/osafalisayed/aikaatib",
