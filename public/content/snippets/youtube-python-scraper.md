...
- Automation
- Selenium
title: Youtube Channel Scraper (Python)
description: This script lets you scrape youtube channels so that you can use them in generating the leads.

---
# Youtube Channel Scraper (Python)

This script lets you scrape youtube channels so that you can use them in generating the leads.
...
Enter the number of times to scroll the page when prompted.
The script will scrape the YouTube search results and save the channel names and subscriber counts in an Excel file named <search_keyword>_youtube_channels.xlsx.
