  ...
  return (
    <section id="home" className="mb-20">
      <div className="flex items-center gap-5 mb-6">
        <div className="w-16 h-16 rounded-full bg-neutral-800 overflow-hidden border-2 border-neutral-800 ring-2 ring-white/10">
          <Image
      ...
      <p className="text-neutral-400 text-base leading-relaxed">
        I specialize in building robust backend systems and fluid frontend interfaces. 
        Based in India, currently solving data problems at <span className="text-white font-medium">Ecomlytix</span>.
      </p>
    </section>
  );
}  