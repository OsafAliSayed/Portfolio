  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: 'flex',
        head_cell:
          'text-text-dark rounded-md w-9 font-normal text-[0.8rem]',
        ...
        day_outside:
          'day-outside text-text-dark opacity-50 aria-selected:bg-secondary/50 aria-selected:text-text-dark aria-selected:opacity-30',
        day_disabled: 'text-text-dark opacity-50',
        day_range_middle:
