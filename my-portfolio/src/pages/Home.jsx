      ...
      <div className="home-container">
        <div className="home-left">
          ...
          <p className="home-description">
            ...
            I create seamless user experiences and robust backend systems to bring ideas to life.
          </p>
        ...
        <div className="home-right">
          <div className="profile-image-container">
            <img src="/images/home-portfolio-img.jpg" alt="Osaf" className="profile-image" />
          </div>
        </div>
      </div>
    </section>
